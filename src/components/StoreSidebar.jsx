                ...
                <form className="store-sidebar--form">
                    ...
                    <div>
                        ...
                        <div className= "store-radio">
                            <label>
                                <input type="radio" name="storeType" id="common" value="common" defaultChecked={true} /> Common
                            </label>
                            <label>
                                <input type="radio" name="storeType" id="rare" value="rare" /> Rare
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="flex-center">
                        ...
                        <div className="flex-column">
                            <label htmlFor="weapons">
                                <input className="marginr-xs" type="checkbox" name="itemClassFilter" id="weapons" defaultChecked={true}/>
                                Weapons
                            </label>
                            <label htmlFor="consumables">
                                <input className="marginr-xs" type="checkbox" name="itemClassFilter" id="consumables"/>
                                Consumables
                            </label>
                            <label htmlFor="companions">
                                <input className="marginr-xs" type="checkbox" name="itemClassFilter" id="companions"/>
                                Companions
                            </label>
                            <label htmlFor="realEstate">
                                <input className="marginr-xs" type="checkbox" name="itemClassFilter" id="realEstate"/>
                                Real Estate
                            </label>
                        </div>
                    </div>
